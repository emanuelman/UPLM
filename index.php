...
<body>
    ...
    <div id="corpo-form">
    <div style="box-shadow: 0px 0px 6px 0px rgba(0, 0, 0, 0.5);" class="container">
        <h1>Entrar</h1>
        <form method="POST">
            ...
            <label class="label-input" for="">
                ...
                <input type="password" name="senha" placeholder="Senha" id="myInput">
                <input class="checkbox1" type="checkbox" onclick="myFunction()">
            </label>
            <button class="btn btn-second" type="submit">ENTRAR</button>
            <a href="cadastrar.php">Ainda não possui uma conta?<strong> Cadastre-se!</strong></a>
        </form>
    </div>
    </div>
